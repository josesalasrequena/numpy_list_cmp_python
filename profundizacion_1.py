...
if __name__ == '__main__':
    ...
    lista_3= [randint(1,10) for x in range(3)] # Generar 3 numeros aleatorios
    print(lista_3)
    suma_lista = sum(lista_3)
    print(suma_lista)
    if suma_lista <= 21:
        print('La suma de los numeros es:', suma_lista, 'Los numeros recolectados fueron:', lista_3) 
    else:
        print('Perdiste')
print("terminamos")