...
if __name__ == '__main__':
    ...
    list_int = [x if x.isdigit() else 0 for x in list_numeros_str]
    print(list_int)
    ...
    list_int_2 = [x if x.isdigit() else 0 for x in list_numeros_str_2]
    print(list_int_2) # [0, '2', '3', 0, '7', 0] Si es negativo se reemplaza a 0
    print("terminamos")