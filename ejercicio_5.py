...
if __name__ == '__main__':
    ...
    # personal_1_10 = [.....]
    list_acc = [x for x in accesos if (1<= x and x<=10)]
    print(list_acc)
    cantidad_personal = len(list_acc)
    print("Cantidad de Personas que paso por este molinete:", cantidad_personal)
    ...
    print('Personal Validado es:', personal_valido)
    print("terminamos")